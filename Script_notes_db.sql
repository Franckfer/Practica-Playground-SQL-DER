CREATE DATABASE  IF NOT EXISTS `Script_notes_db` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `Script_notes_db`;
-- MySQL dump 10.13  Distrib 5.5.62, for Win64 (AMD64)
--
-- Host: localhost    Database: Script_notes_db
-- ------------------------------------------------------
...
CREATE TABLE `deleted` (
  ...
  `notes_deleted` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notes` (
  ...
  `security_deleted` int(1) DEFAULT NULL,
...
--
-- Dumping routines for database 'der_playground'
--
...
-- Dump completed on 2021-11-06  1:29:07
